						...
						<tr>
							...
							<td>
								<select name="r_seat_type">
									<option value="">선택</option>
									<option value="일반석" <%if(reservationVo.getR_seat_type()=="일반석"){%>selected<%}%>>일반석</option>
									<option value="비지니스석" <%if(reservationVo.getR_seat_type()=="비지니스석"){%>selected<%}%>>비지니스석</option>
									<option value="일등석" <%if(reservationVo.getR_seat_type()=="일등석"){%>selected<%}%>>일등석</option>
								</select>
							</td>
						</tr>
						<tr>
